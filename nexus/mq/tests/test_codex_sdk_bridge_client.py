    ...
    sidecar.write_text(
        "\n".join(
            [
                ...
                "print(json.dumps({'type': 'result', 'status': 'completed_execution', 'thread_id': 'thread-001', 'turn_id': 'turn-001', 'output_text': 'SDK_OK', 'evidence_refs': ['sdk://event/thread.started']}), flush=True)",
