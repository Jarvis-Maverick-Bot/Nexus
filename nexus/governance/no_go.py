    ...
    def default(cls) -> "NoGoBoundaryPolicy":
        return cls(
            blocked_actions={
                ...
                "local_app_framework_selection": ErrorCode.NO_GO_BOUNDARY,
                "local_app_database_selection": ErrorCode.NO_GO_BOUNDARY,
                "local_app_api_schema_selection": ErrorCode.NO_GO_BOUNDARY,
                "local_app_package_manager_selection": ErrorCode.NO_GO_BOUNDARY,
                "local_app_server_selection": ErrorCode.NO_GO_BOUNDARY,
                "local_app_runtime_invocation": ErrorCode.NO_GO_BOUNDARY,
                "local_app_dispatch_execution": ErrorCode.NO_GO_BOUNDARY,
                "local_app_route_activation": ErrorCode.NO_GO_BOUNDARY,
                "local_app_view_model_authority": ErrorCode.NO_GO_BOUNDARY,
                "local_app_direct_canonical_mutation": ErrorCode.NO_GO_BOUNDARY,
                "local_app_approval": ErrorCode.NO_GO_BOUNDARY,
                "local_app_completion": ErrorCode.NO_GO_BOUNDARY,
                "local_app_archive": ErrorCode.NO_GO_BOUNDARY,
                "local_app_baseline": ErrorCode.NO_GO_BOUNDARY,
                "local_app_no_go_decision": ErrorCode.NO_GO_BOUNDARY,
                "local_app_production_readiness": ErrorCode.NO_GO_BOUNDARY,
                "local_app_deploy": ErrorCode.NO_GO_BOUNDARY,
                "local_app_continuity_activation": ErrorCode.NO_GO_BOUNDARY,
                "local_app_final_pass": ErrorCode.NO_GO_BOUNDARY,
            }
        )
